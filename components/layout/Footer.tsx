...
export default function Footer() {
  return (
    <footer className="bg-ionic-darker border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/customize" className="text-white/50 hover:text-white transition-colors text-sm">
                  Design Your Kit
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2 text-white/50 text-sm">
                ...
                <a href={`https://wa.me/${siteConfig.whatsappNumber.replace(/[^0-9]/g, '')}`} className="hover:text-white transition-colors">
